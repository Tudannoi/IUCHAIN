...
const Patient = () => {
  ...
  if (loading || loadingRecords) {
    ...
    return (
      <Box display='flex' justifyContent='center' width='100vw'  borderRadius={10} width='100vw'>
        <Box width='60%' my={5}>
          <Backdrop sx={{ color: '#fff', zIndex: theme => theme.zIndex.drawer + 1 }} open={loading}>
            <CircularProgress color='inherit' />
          </Backdrop>
            ...
            <>
              ...
              {role === 'patient' && (
                <>
                  ...
                  >
                   <Typography variant='h4'><img alt="Profile" src={record} style={{ height: 35}} alignItems='left'  /> My Records </Typography>
