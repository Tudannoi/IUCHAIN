...
const Doctor = () => {
  ...
  if (loading) {
    ...
    return (
      <Box display='flex' justifyContent='center' width='100vw'  borderRadius={10}  backgroundColor='#8BCDC4 '>
        <Box width='70%' my={5}>
          {!accounts ? (
            ...
            <>
              ...
              {role === 'doctor' && (
                <>
                  ...
                  <Typography variant='h4'><img alt="Profile" src={record} style={{ height: 35}} alignItems='left'  /> Patient Records </Typography>
                  ...
                  <Box
                    ...
                    my={1}
                  >
                  <Typography variant='h4'><img alt="Profile" src={register} style={{ height: 35}} alignItems='left'  ></img> Register Patient</Typography>
                  <Box display='flex' alignItems='center' my={1}>
                    <FormControl fullWidth>
                      <TextField
                        variant='outlined'
