...
const HeaderAppBar = () => {
  ...
  return (
    <AppBar  position='static' style={{ backgroundColor: 'white'  }}>
      <Toolbar >
        <Box position='static' display='flex'  justifyContent='space-between' alignItems='center' width='100%' >
          <a href='/'>
            <img src={logo} alt='med-chain-logo' style={{ height: 60, weight: 100 }} />
          </a>
          <Typography variant='h5' width="flex" color='black'>ELECTRONIC HEALTH RECORD SYSTEM </Typography>
          <Box flexGrow={1}  />
